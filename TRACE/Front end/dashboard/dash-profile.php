            ...
            <section class="main">
                <div class="main-top">
                    ...
                    <div class="main-board">
                        ...
                        <div class="box">
                            <p class="lab">Academic year: </p>
                            <p class="val"><?php echo $_SESSION['year'] ?></p>
                        </div>
                        <div class="box">
                            <p class="lab">Branch: </p>
                            <p class="val"><?php echo $_SESSION['branch'] ?></p>
                        </div>
                        <div class="box">
                            <p class="lab">Semester: </p>
                            <p class="val"><?php echo $_SESSION['sem'] ?></p>
                        </div>
                        <div class="box">
